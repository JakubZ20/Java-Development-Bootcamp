    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(option.equalsIgnoreCase("stay")){
                ...
                int additCard = drawRandomCard();
                System.out.println("\nYou extra card is: \n" + cardString(additCard)); 
                total += Math.min(additCard,10);
                System.out.println("\nYour new total equals: \n" + total);
                if(total>21){
                    System.out.println("\nBust! Player loses ! \n");
                    System.exit(0);
                }
        ...
        while(dealerTotal<17){
            int additCardDealer = drawRandomCard();
            System.out.println("\nDealer gets a: \n" + cardString(additCardDealer)); 
            dealerTotal += Math.min(additCardDealer,10);
