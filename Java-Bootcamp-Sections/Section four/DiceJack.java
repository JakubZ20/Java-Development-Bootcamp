...
public class DiceJack {
    public static void main(String[] args) {
        ...
        if(num1<1 || num2<1 || num3 <1 ){
            System.out.println("Numers can not be less then 1. Shutting game down");
            System.exit(0);
        }

        if(num1>6 || num2>6 || num3 >6 ){
            System.out.println("Numers can not be greater then 6. Shutting game down");
            System.exit(0);
        }
        ...
        if (checkWin(sumDiceRolls, sumOfNumbers)){
            ...
            System.out.println("Sorry, you lose :c");
        }
